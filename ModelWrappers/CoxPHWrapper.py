...
class CoxPHWrapper:
    def __init__(self, cfg, base_augment, seed):
        self.cfg = cfg
        self.base_augment = base_augment
        self.seed = seed
        self.best_c_index, self.avg_c_index, self.cph, self.train, self.test = self.cph_KFold()
    ...
    def cph_KFold(self):
        ...
        kf = KFold(n_splits=self.cfg['n_folds'], shuffle=True, random_state=self.seed)
    ...
    def plot_SurvivalCurves(self, stage):
